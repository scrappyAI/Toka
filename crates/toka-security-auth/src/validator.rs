...
//!
//! Slice 4 introduces a *pluggable* validator so components can swap
//! verification logic (e.g. symmetric JWT today, Paseto or key-rotated
//! JWK tomorrow) without leaking crypto details upward.
